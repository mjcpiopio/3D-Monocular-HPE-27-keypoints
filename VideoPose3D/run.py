...
if args.dataset == 'h36m':
    ...
    file_name = 'data_2d_custom_myvideos.npz'
    script_directory = os.getcwd()
    npz_file_path = os.path.join(script_directory, 'data', file_name)
    print("Attempting to load file from:", npz_file_path)
    dataset = CustomDataset(npz_file_path)
else:
...
npz_file_path = os.path.join(script_directory, 'data', file_name)
print("Attempting to load file from:", npz_file_path)
keypoints = np.load(npz_file_path, allow_pickle=True)
